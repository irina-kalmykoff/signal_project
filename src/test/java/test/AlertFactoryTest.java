...
/**
 * These tests focus on the factory pattern implementation, ensuring that the right alert factories are invoked for the right conditions. 
 * They use test data generated by TestDataGenerator and verify the entire alert generation process from data to alert.
 */
public class AlertFactoryTest {
    ...
    public void setUp() throws IOException {
        ...
        // Set up test manager
        testManager = new TestAlertFactoryManager(dataStorage);
    }
    ...
    public void testNormalPatient() {
        ...
        List<Alert> alerts = testManager.getAllAlerts();
    ...
    public void testIncreasingBloodPressureTrend() {
        ...
        List<PatientRecord> bpRecords = patient.getRecords(0, Long.MAX_VALUE)
        .stream()
        .filter(r -> r.getRecordType().equals("SystolicPressure"))
        .sorted(Comparator.comparing(PatientRecord::getTimestamp))
        .collect(Collectors.toList());
    
        System.out.println("DEBUG - Patient 1 systolic BP values:");
        for (PatientRecord record : bpRecords) {
            System.out.println("  Time: " + record.getTimestamp() + ", Value: " + record.getMeasurementValue());
        }
        
        testManager.checkAllAlerts(patient);
        boolean hasIncreasingTrendAlert = testManager.containsAlertWithKeyword("Increasing");
        ...
        testManager.checkAllAlerts(patient);
        //List<Alert> alerts = testManager.getAllAlerts();
        hasIncreasingTrendAlert = testManager.containsAlertWithKeyword("Increasing");
    ...
    public void testDecreasingBloodPressureTrend() {
        ...
        testManager.checkAllAlerts(patient);
        boolean hasDecreasingTrendAlert = testManager.containsAlertWithKeyword("Decreasing");
        ...
        testManager.checkAllAlerts(patient);
        hasDecreasingTrendAlert = testManager.containsAlertWithKeyword("Decreasing");
    ...
    public void testBloodPressureThresholds() {
        ...
        testManager.checkAllAlerts(patient);
        boolean hasHighBPAlert = testManager.containsAlertWithKeyword("high") && 
                                  testManager.containsAlertWithKeyword("pressure");
        ...
        testManager.checkAllAlerts(patient);
        boolean hasLowBPAlert = testManager.containsAlertWithKeyword("low") && 
                                 testManager.containsAlertWithKeyword("pressure");
        ...
        assertEquals(0, testManager.getAllAlerts().size(), "Should not alert for exactly at high threshold");
        ...
        assertEquals(0, testManager.getAllAlerts().size(), "Should not alert for exactly at low threshold");
    }
    ...
    public void testOxygenSaturation() {
        ...
        assertEquals(0, countAlertsOfType(testManager.getAllAlerts(), "low oxygen"),
        ...
        testManager.checkAllAlerts(patient);
        for (Alert alert : testManager.getAllAlerts()) {
    ...
    public void testRapidSaturationDrop() {
        ...
        testManager.checkAllAlerts(patient);
        boolean hasRapidDropAlert = testManager.containsAlertWithKeyword("Rapid") && 
                                     testManager.containsAlertWithKeyword("Drop");
        ...
        assertEquals(0, testManager.getAllAlerts().size(), "Should not alert for drop over extended period");
    }
    ...
    public void testHypotensiveHypoxemia() {
        ...
        testManager.checkAllAlerts(patient);
        boolean hasHypotensiveHypoxemiaAlert = testManager.containsAlertWithKeyword("Hypotensive") && 
                                               testManager.containsAlertWithKeyword("Hypoxemia");
        ...
        testManager.checkAllAlerts(patient);
        hasHypotensiveHypoxemiaAlert = testManager.containsAlertWithKeyword("Hypotensive") && 
                                        testManager.containsAlertWithKeyword("Hypoxemia");
    ...
    public void testECGAbnormalities() {
        ...
        // Run the test
        testManager.checkAllAlerts(patient);
        boolean hasECGAlert = testManager.containsAlertWithKeyword("ECG") && 
                              testManager.containsAlertWithKeyword("Abnormality");
    ...
    public void testTriggeredAlert() {
        ...
        testManager.checkAllAlerts(patient);
        boolean hasButtonAlert = testManager.containsAlertWithKeyword("Call Button") || 
                                 testManager.containsAlertWithKeyword("Assistance");
